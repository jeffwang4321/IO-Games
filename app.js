...
var PromptPool = [
    ...
    "Two men were walking down the street when _____ ",
    ...
    "You're going on a first dat. What do you do?",
    ...
    "Men only want one thing and its disgusting, _____",
    "_____ kinda SUS. I saw them _____",
    "I identify as _____, so I don't have to _____",
    "_____? I am _____",
    "MFs _____, but _____",
    "Whats worse than walking down downtown eastside late at night in december?",
    "When I go beat off, I usually search up _____",
    "Is it too much to ask for _____",
    "What the worst thing that can happen when walking down a dark alley?",
    "Science is _____",
